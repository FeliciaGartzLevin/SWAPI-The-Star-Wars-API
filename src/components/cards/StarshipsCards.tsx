		...
		<div className="col-lg-4 col-md-6 col-sm-12 mb-3">
			<div className="card d-flex h-100 card-bg">
				<div className="card-body d-flex flex-column">
					...
					<h3 className="card-subtitle mb-2 text-muted h6">Starship Class: {resource.starship_class} hrs</h3>
					<h3 className="card-subtitle mb-2 text-muted h6">Manufacturer: {resource.manufacturer} earthdays</h3>
					...
					<p className="card-text flex-fill">{resource.name} has {resource.pilots_count} and appears in {resource.films_count} films.</p>
					<Link
